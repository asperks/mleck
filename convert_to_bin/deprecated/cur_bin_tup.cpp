...
#include "cur_bin_tup.h"

void cur_bin_tup::add_double_ticker(string str_ticker, string str_key, double d_val) {
...
void cur_bin_tup::set_tup_candle300(string str_ticker, vector<tuple<int, double, double, double, double, double, double, double>> vec) {
	map_vec_candle300.emplace(str_ticker, std::move(vec));
}


void cur_bin_tup::set_tup_candle14400(string str_ticker, vector<tuple<int, double, double, double, double, double, double, double>> vec) {
	map_vec_candle14400.emplace(str_ticker, std::move(vec));
}


void cur_bin_tup::set_tup_history(string str_ticker, vector<tuple<int, double, bool, double>> vec) {
	map_vec_history.emplace(str_ticker, std::move(vec));
}


void cur_bin_tup::set_tup_orderbook(string str_ticker, vector<tuple<double, double, double, double>> vec) {
	map_vec_orderbook.emplace(str_ticker, std::move(vec));
}


void cur_bin_tup::clear() {
